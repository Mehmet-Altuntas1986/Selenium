...
public class RepeatOptionsTest extends TestBase {
    ...
    */
                                             //15 dk verdi cozmeleri icin  -bu tasklari ilerde tek basina yapmaya calis
    @Test
    public void test1(){
        ...
        //Verify that repeat every days is checked (choosen)
        Assert.assertTrue(createCalendarEventsPage.days.isSelected(),"Verify repeat days is selected");   //days is a WebElement in CreateCalenderEventsPage class
        //verify that repeat weekday is not checked
