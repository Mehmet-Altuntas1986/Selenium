...
public class Driver {  //utilities paketinde   //Bu ONCEDEN OLUSTURMUS OLDUGumuz WebDriverFactory classindan daha fazla browser a ulasmamizi sagliyor
    ...
    private Driver() {}  //diger class larda bu class in object i olusturulamaz , heryerde bu classda olusturdugumuz objecti kullanabiliriz (Singleton)
...
//ConfigurationReader is in utilities package
